...
Before starting, you will need to verify that all the :ref:`Requirements` for the version desired are already installed. 
...
``compute_flow`` function takes as input many **parameters** as how it was described in :ref:`Compute flow` and returns :math:`u`, :math:`v` the horizontal and vertical optical flow field respectively.
